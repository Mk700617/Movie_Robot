...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,ʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ  <a href='https://t.me/TheMoviesRequests'>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ👇 </b>"),
                ...
                if clicked == typed:
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_message(
                            ...
                            protect_content=True if ident == 'subp' else False,
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b><b>Tʜᴇ Rᴇꜱᴜʟᴛꜱ Fᴏʀ 👉 {search},                               Rᴇǫᴜᴇsᴛᴇᴅ Bʏ 👉 {message.from_user.mention},                                   ⚠️ ᴀꜰᴛᴇʀ 10 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️</b></b>"
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        button = [[
                   InlineKeyboardButton("Oᴡɴᴇʀ ʀᴇǫᴜᴇsᴛ", url=f"t.me/Reqstmovies")
        ]]
        if NO_RESULTS_MSG:
